...
local V = {
				...
				Name =	"2007 Ford Crown Victoria Police Interceptor",
				...
				Model =	"models/sentry/static/cop_cvpi.mdl",
...
VC_ExtraSeats = { //Can be an infinite amount of seats, Pos and ExitPos can be a simple Vector() or an attachment name, other options are self explanatory.
							{Pos = Vector(18,1,10), Ang = Angle(0, 0, 0), EnterRange = 180, ExitAng = Angle(0, -90, 0), ExitPos = Vector(68,5,13), Model = "models/nova/jeep_seat.mdl", ModelOffset = Vector(0, 0, 0), Hide = true, DoorSounds = true},
							{Pos = Vector(18,-40,12), Ang = Angle(0, 0, 0), EnterRange = 180, ExitAng = Angle(0, -90, 0), ExitPos = Vector(68,-34,15), Model = "models/nova/jeep_seat.mdl", ModelOffset = Vector(0, 0, 0), Hide = true, DoorSounds = true},
							{Pos = Vector(0,-40,12), Ang = Angle(0, 0, 0), EnterRange = 180, ExitAng = Angle(0, -90, 0), ExitPos = Vector(68,-14,15), Model = "models/nova/jeep_seat.mdl", ModelOffset = Vector(0, 0, 0), Hide = true, DoorSounds = true},
							{Pos = Vector(-18,-40,12), Ang = Angle(0, 0, 0), EnterRange = 180, ExitAng = Angle(0, -90, 0), ExitPos = Vector(-68,-34,15), Model = "models/nova/jeep_seat.mdl", ModelOffset = Vector(0, 0, 0), Hide = true, DoorSounds = true},
							},
