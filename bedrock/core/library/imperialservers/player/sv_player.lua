...
function PLAYER:NetworkImperialGlobal()
	self:SetNW("userlevel", self:GetData("imperial_account", "userlevel", Config("ranks").PLAYER))
	self:SetNW("viplevel", self:GetData("imperial_account", "donations", 0))
end
