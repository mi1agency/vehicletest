...
imperial = imperial or {}

function ENTITY:IsDoor() return IsValid(self) and string.find(self:GetClass(), "door") or false end
function ENTITY:IsLocked(b) if (self:IsDoor() or self:IsVehicle()) and self.Class then return self.Class:GetLocked() end return self:GetNW("Locked", b) end
