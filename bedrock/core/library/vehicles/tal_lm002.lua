local V = {
			...
			Information = "A drivable LM002 BY Talon733",
			Model = "models/talonvehicles/tal_lambo_lm002.mdl",
			...
			KeyValues = {
							vehiclescript	=	"scripts/vehicles/tal_lm002.txt"
							}
			}
list.Set("Vehicles", "tallm002", V)