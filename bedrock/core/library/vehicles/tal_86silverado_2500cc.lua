local V = {
			Name = "1986 Chevy/Gmc Silverado 2500 Crew cab", 
			Class = "prop_vehicle_jeep",
			Category = "Talon's Vehicles",
			Author = "Talon733, Dalax",
			Information = "A drivable Silverado BY Talon733",
			Model = "models/talonvehicles/tal_gm_silverado_2500_cc.mdl",
			...
			KeyValues = {
							vehiclescript	=	"scripts/vehicles/tal_86silverado_2500.txt"
							}
			}
list.Set("Vehicles", "tal86silverado_2500cc", V)